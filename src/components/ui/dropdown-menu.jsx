  ...
  return (
    (<DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=warning]:text-yellow-600 data-[variant=warning]:focus:bg-yellow-100 dark:data-[variant=warning]:focus:bg-yellow-300/20 data-[variant=warning]:focus:text-yellow-700 data-[variant=warning]:*:[svg]:!text-yellow-600",
        className
      )}
      {...props} />)
  );
